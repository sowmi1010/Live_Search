defmodule SearchFormWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SearchFormWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SearchFormWeb.Gettext, "errors", msg, opts)
    end
  end
