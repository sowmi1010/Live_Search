defmodule SearchFormWeb.BusLive do
  ...
  def getBuses do
    [
      ...
      %{from: "Chennai", to: "Villupuram", price: "980", timing: "02:00 PM"},
      ...
      %{from: "Kanyakumari", to: "Theni", price: "1139", timing: "09:00 PM"},
      %{from: "Chennai", to: "Coimbatore", price: "1099", timing: "08:00 AM"},
      %{from: "Theni", to: "Villupuram", price: "1139", timing: "07:00 AM"}
    ]
  end
end
